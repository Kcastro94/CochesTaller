...
public class MainVehiculos {
    public static void main(String[] args) {
        Coche Jaguar = new Coche("1234ENG", "Jaguar", "TheRoadIsYours", 200000.00);
        Coche BMW = new Coche("9065AME", "BMW", "LoveAtFirstDrive", 60000.00);
        Coche Lexus = new Coche("5638DDD", "Lexus", "FastAndGlorious", 120000.00);
        Coche Austin = new Coche("3564GER", "Austin", "BeLikeBond", 150000.00);
        Coche RomeoAlfaJulietta = new Coche("4749JAV", "RomeoAlfaJulietta", "DramaMasterpiece", 12000.00);
